package xyz.un4ckn0wl3z.ircbot.psyberboz;
...
import xyz.un4ckn0wl3z.ircbot.psyberboz.utils.RegistryUtils;

public class Client {
	public static Client instance;
	private String ircServer = "server";
	private String ircChannel = "channel";
    ...
    // decypt string...
    private String decrypt(String encryptedHex) throws NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, InvalidAlgorithmParameterException{
    	String iv = "iv";
        String key = "key";
