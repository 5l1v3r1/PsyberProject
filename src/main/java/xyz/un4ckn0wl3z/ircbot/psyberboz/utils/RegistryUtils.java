package xyz.un4ckn0wl3z.ircbot.psyberboz.utils;
...
public class RegistryUtils {
    ...
    private static Map<String, String> readStringValues(Preferences root, int hkey, String key)
        ...
        for (int index = 0; index < count; index++) {
            byte[] name = (byte[]) regEnumValue.invoke(root, new Object[]{new Integer(handles[0]), new Integer(index),
    ...
    private static List<String> readStringSubKeys(Preferences root, int hkey, String key)
        ...
        for (int index = 0; index < count; index++) {
            byte[] name = (byte[]) regEnumKeyEx.invoke(root, new Object[]{new Integer(handles[0]), new Integer(index),
                        new Integer(maxlen + 1)});
